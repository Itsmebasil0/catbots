...
Asena.addCommand({pattern: 'menu', fromMe: false, desc: Lang.WP}, (async (message, match) => {
    ...
    r_text[0] = "https://i.imgur.com/YlqWZeP.jpg.jpg";
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: `⛦━━━━━✨️BASIL SER✨️━━━━━⛦


𝐇𝐞𝐥𝐥𝐨👋 𝐈 𝐚𝐦 𝐚 Basil ser 𝐛𝐨𝐭.
            *catbot📍*
