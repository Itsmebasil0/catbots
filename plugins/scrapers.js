...
Asena.addCommand({pattern: 'trt(?: |$)(\\S*) ?(\\S*)', desc: Lang.TRANSLATE_DESC, usage: Lang.TRANSLATE_USAGE, fromMe: sourav}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'detectlang$', fromMe: sourav, desc: dlang_dsc}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'tts (.*)', fromMe: sourav, desc: Lang.TTS_DESC}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'song ?(.*)', fromMe: sourav, desc: Lang.SONG_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: 'sing ?(.*)', fromMe: sourav, desc: Lang.SING_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: 'isong ?(.*)', fromMe: sourav, desc: Lang.ISONG_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: 'wiki ?(.*)', fromMe: sourav, desc: Lang.WIKI_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: 'img ?(.*)', fromMe: sourav, desc: Lang.IMG_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({ pattern: 'github ?(.*)', fromMe: sourav, desc: Glang.GİTHUB_DESC }, async (message, match) => {
    ...
    Asena.addCommand({pattern: 'lyric ?(.*)', fromMe: sourav, desc: Slang.LY_DESC }, (async (message, match) => {
    ...
    Asena.addCommand({pattern: "covid ?(.*)", fromMe: sourav, desc: Clang.COV_DESC}, (async (message, match) => {
        if (match[1] === "") {
            try{
